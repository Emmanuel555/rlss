#ifndef RLSS_BOREALIS_PLANNING_HPP
...
#define RLSS_BOREALIS_PLANNING_HPP// allows the definition of macros within the code itself, for eg. macros allow constant 
...
#endif //Borealis_Planning_Borealis_Planning_HPP
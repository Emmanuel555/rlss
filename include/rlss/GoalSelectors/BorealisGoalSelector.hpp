#ifndef RLSS_BOREALIS_GOAL_SELECTOR_HPP
#define RLSS_BOREALIS_GOAL_SELECTOR_HPP
...
class BorealisGoalSelector: public GoalSelector<T, DIM> {
public:
    ...
    BorealisGoalSelector( // constructor
        T deshor,
